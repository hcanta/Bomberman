...
"""Lobby OptionsMenu Substate"""
class OptionsMenu(Substate):
	...
	def __init__(self, screen, fpsclock, sound):
		super(OptionsMenu, self).__init__(screen, fpsclock, sound)
