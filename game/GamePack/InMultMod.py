...
class InMult(Substate):

	""" 
	Initiates a multiplayer game.
	"""
	def __init__(self, screen, fpsclock, sound, alternate):
		super(InMult, self).__init__(screen, fpsclock, sound)
	...
	def _initObjects(self):
		...
		self._player_1 = AuthInfo.user_one
		self._player_2 = AuthInfo.user_two
		self._player2 =  AuthInfo.user_two
		...
		self._player0 = Player(0, AuthInfo.user_one.username,0)
		self._player1 = Player(0, AuthInfo.user_one.username,0)
		self._player2 = Player(1, AuthInfo.user_two.username,0)
	...
	def _initImages(self):
		...
		self._p2d1_file = "sprites/p2d1.gif"
		self._p2d2_file = "sprites/p2d2.gif"
		...
		self._p2u1_file = "sprites/p2u1.gif"
		self._p2u2_file = "sprites/p2u2.gif"
		self._p2l1_file = "sprites/p2l1.gif"
		self._p2l2_file = "sprites/p2l2.gif"
		self._p2r1_file = "sprites/p2r1.gif"
		self._p2r2_file = "sprites/p2r2.gif"

		self._bonus0_file = "sprites/health.png"
		self._bonus1_file = "sprites/extra_bomb.gif"
		self._bonus2_file = "sprites/range.png"
		self._exit_file = "sprites/rubis.gif"
		...
		self._p2d1_image = pygame.image.load(self._p2d1_file)		
		self._p2d2_image = pygame.image.load(self._p2d2_file)

		self._p2u1_image = pygame.image.load(self._p2u1_file)
		self._p2u2_image = pygame.image.load(self._p2u2_file)

		self._p2l1_image = pygame.image.load(self._p2l1_file)
		self._p2l2_image = pygame.image.load(self._p2l2_file)

		self._p2r1_image = pygame.image.load(self._p2r1_file)
		self._p2r2_image = pygame.image.load(self._p2r2_file)
	...
	def _nextLevel(self):
		...
		if(self._currentPlayer == 1):
			self._level+=1
			self._player = self._player_1
			self._player2 = self._player1
			self._player1 = self._player0
		else:
			self._player=self._player_2
	...
	def _isTimeOver(self):		 		
 		...
 		if done: 
 			self._highScoreDB.updateCurrentLevelFor(self._player0._getName(),(1))
 			self._highScoreDB.updateCurrNumLivesFor(self._player0._getName(),3)
 			self._highScoreDB.updateCurrentLevelFor(self._player2._getName(),(1))
 			self._highScoreDB.updateCurrNumLivesFor(self._player2._getName(),3)
	...
	def _render(self):
		...
		self._screen.blit(self._playerName, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+35, 10))
		self._screen.blit(self._playerStats, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+35, 35))
		self._screen.blit(self._playerOStats, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+35, GameConfigs.TILE_RESOLUTION*4+30))
		...
		for idx in range(GameConfigs.BOARD_SIZE*GameConfigs.BOARD_SIZE):
			...
			if cont == "P1":
				if self._currentPlayer == 0:
					...
					if self._player1._getState() =="D1":
						self._screen.blit(self._p2d1_image, (x,y))				
					if self._player1._getState() =="D2":
						self._screen.blit(self._p2d2_image, (x,y))
					if self._player1._getState() =="U1":
						self._screen.blit(self._p2u1_image, (x,y))
					if self._player1._getState() =="U2":
						self._screen.blit(self._p2u2_image, (x,y))
					if self._player1._getState() =="L1":
						self._screen.blit(self._p2l1_image, (x,y))
					if self._player1._getState() =="L2":
						self._screen.blit(self._p2l2_image, (x,y))
					if self._player1._getState() =="R1":
						self._screen.blit(self._p2r1_image, (x,y))
					if self._player1._getState() =="R2":
						self._screen.blit(self._p2r2_image, (x,y))
		...
		self._screen.blit(level, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+25,GameConfigs.TILE_RESOLUTION*2+10))
		nbKills = self._fontt.render("#Kills: "+str(self._player1._getNbKills()), True, OtherConfigs.COLOR_BLACK)
		self._screen.blit(nbKills, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+25,GameConfigs.TILE_RESOLUTION*3-5))
		nbDeath = self._fontt.render("#Death: "+str(self._player1._getNbDeath()), True, OtherConfigs.COLOR_BLACK)
		self._screen.blit(nbDeath, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+25,GameConfigs.TILE_RESOLUTION*3+20))
		...
		self._screen.blit(nbLevelCompleted, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+25,GameConfigs.TILE_RESOLUTION*5+25))
		...
		self._screen.blit(maxLevel, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+25,GameConfigs.TILE_RESOLUTION*6+10))
		...
		self._screen.blit(overallKills, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+25,GameConfigs.TILE_RESOLUTION*6+35))

		overallKDR = self._fontt.render("KDR: "+str(self._highScoreDB.getKDROf(self._player.username)), True, OtherConfigs.COLOR_BLACK)
		self._screen.blit(overallKDR, ((GameConfigs.BOARD_SIZE)*GameConfigs.TILE_RESOLUTION+25,GameConfigs.TILE_RESOLUTION*7+20))
